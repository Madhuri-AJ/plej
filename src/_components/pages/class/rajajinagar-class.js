...
class RajajinagarClass extends Component {
    constructor(props) {
        super(props);
                            ...
                            <div style={{ "width": "100%" }}>
                                ...
                                <div class="_3Fst1pU _3x6v3-y fourclass">
                                    <div class="_2gpiPPm _2WGnI5T _2rbE6TC _2v5bHvx"><img
                                        ...
                                        class="_3h_jpHd" /></div>
                                    <h3 class="rfn1m5O">Group Classes</h3><span class="_GcKgjb"></span><NavLink className="_1nR3q81 sDHKtsB"
                                        to="/class/amrap"></NavLink>
                                </div>
                            </div>
                        </div>
...
export default RajajinagarClass;