...
class Header extends Component {
    ...
    handleSubmit = (event) => {
        ...
        payload.append("product_name",`from_email=raj@movezafitness.com&to_email=raj@movezafitness.com&name=${name}&email=${email}&number=${number}&location=${text}&subject=Book a free trial`);
